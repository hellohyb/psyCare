<template>
    <div  ref="sectionRef"  class="top-section flex justify-center items-center !p-4 w-full">
        <div class="section2 flex flex-col bg-white items-center rounded-lg md:!p-20 justify-start w-full md:max-w-[1100px]">
            ...
            <h3 class="text-sm md:text-md md:font-bold text-center fade-in">{{ t('c_section5_title_desc2') }}</h3>
            <div class="window-content grid grid-cols-1 w-full md:overflow-hidden !mt-10 md:h-140 md:bg-[#FCDD65] md:shadow-lg rounded-lg md:relative">
                <!-- 第一个窗口 -->
                <div class="window fade-in w-full !mt-10 border-1 border-gray-200 md:border-none rounded-lg md:absolute md:z-10 !p-4 md:!p-18 md:bottom-0 md:h-50 md:left-10 md:w-133 md:h-120 flex flex-col justify-start items-start">
                ...
                <!-- 第二个窗口 -->
                <div class="window fade-in w-full !mt-10 border-1 border-gray-200 md:border-none rounded-lg md:absolute z-11 !p-4 md:!p-18 md:bottom-0 md:left-60 md:w-148 md:h-128 flex flex-col justify-start items-start">
                ...
                <!-- 第三个窗口 -->
                <div class="window fade-in w-full !mt-10 border-1 border-gray-200 md:border-none rounded-lg md:absolute z-12 !p-4 md:!p-18 md:bottom-0 md:-right-40 md:w-170 md:h-138 flex flex-col justify-start items-start">
